...
public class HomeActivity extends AppCompatActivity
    ...
    @BindView(R.id.communities_recycler)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        communities_recycler.setLayoutManager(new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL));
        ...
        arrayList.add(new CommunitiesTest("https://www.hiamag.com/sites/default/files/article/23/11/2017/6225831-836819417.jpg","PRESSURE"));
        ...
        CommunitiesAdapter adapter = new CommunitiesAdapter(arrayList,this);
